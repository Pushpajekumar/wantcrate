  ...
  return (
    ...
    >
      <div className="w-full min-h-screen flex items-center justify-center bg-black">
        <div className="md:w-2/3 w-full py-10 px-4 text-white flex flex-col">
          ...
          <div className="flex mt-8 flex-col md:flex-row md:justify-between">
            <p className="w-full md:w-2/3 text-gray-400">
              To ensure that you grow your business then please connect with us
          ...
          <div className="flex flex-col">
            <div className="flex mt-24 mb-12 flex-row justify-between">
              <div className="">
                <h1 className="text-3xl font-semibold">WantCrate</h1>
              </div>
              <Link to="/about">
            ...
            <p className="w-full text-center my-12 text-gray-600">
              WantCrate Technologies Sangtech Group Pvt Ltd
            </p>
          </div>
        </div>
      </div>
